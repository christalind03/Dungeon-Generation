...
namespace Code.Scripts.Utils.SerializableDictionary.Attributes
{
    ...
    public class SerializableDictionaryAttribute : PropertyAttribute
    {
        ...
        /// <summary>
        /// Creates a new <see cref="SerializableDictionaryAttribute"/> that defines custom display labels for the key and value columns in the Inspector.
        /// </summary>
        ...
        public SerializableDictionaryAttribute(string keyLabel, string valueLabel)
        {
            KeyLabel = keyLabel;
